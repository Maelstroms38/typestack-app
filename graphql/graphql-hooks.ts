...
export type BooksQuery = { __typename?: 'Query' } & {
  books: Array<{ __typename?: 'Book' } & Pick<Book, 'title' | 'author'>>;
};
...
export type CreateBookMutation = { __typename?: 'Mutation' } & {
  createBook: Maybe<{ __typename?: 'Book' } & Pick<Book, 'title' | 'author'>>;
};
...
export function useBooksQuery(
  ...
  return ApolloReactHooks.useQuery<BooksQuery, BooksQueryVariables>(
    BooksDocument,
    baseOptions
  );
}
export function useBooksLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<BooksQuery, BooksQueryVariables>(
    BooksDocument,
    baseOptions
  );
}
...
export type BooksQueryResult = ApolloReactCommon.QueryResult<
  BooksQuery,
  BooksQueryVariables
>;
...
>;
export type CreateBookMutationResult = ApolloReactCommon.MutationResult<
  CreateBookMutation
>;
